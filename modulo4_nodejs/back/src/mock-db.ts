...
export const getAccommodationsList = async () => {
...
export const insertReview = async (id, updatedReview) => {
  return mockAccommodationsList.map((accommodation) =>
    accommodation._id === id
      ? accommodation.reviews.push(updatedReview)
      : accommodation
  );
};