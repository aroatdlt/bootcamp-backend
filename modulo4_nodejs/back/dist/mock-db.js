...
exports.insertReview = exports.getAccommodationsListByCountry = exports.getAccommodationsList = exports.getAccommodationById = void 0;
let mockAccommodationsList = [{
  "_id": "10006546",
  ...
  "number_of_reviews": 0,
  "bathrooms": 1.0,
  "amenities": ["Wifi", "Wheelchair accessible", "Kitchen", "Free parking on premises", "Smoking allowed", "Hot tub", "Buzzer/wireless intercom", "Family/kid friendly", "Washer", "First aid kit", "Essentials", "Hangers", "Hair dryer", "Iron", "Laptop friendly workspace"],
  "price": {
...
const getAccommodationsList = async () => {
  return mockAccommodationsList;
};

exports.getAccommodationsList = getAccommodationsList;

const getAccommodationsListByCountry = async country => {
...
exports.getAccommodationsListByCountry = getAccommodationsListByCountry;
...
const insertReview = async (id, updatedReview) => {
  return mockAccommodationsList.map(accommodation => accommodation._id === id ? accommodation.reviews.push(updatedReview) : accommodation);
};
